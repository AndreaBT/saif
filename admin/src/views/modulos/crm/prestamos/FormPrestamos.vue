                                                    ...
                                                    <div class="col-12 col-sm-12 col-md-9 col-lg-9 col-xl-10">
                                                        <div class="form-group form-row">
                                                            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
																...
																<b-form-input id="Nombre" readonly v-model="objCliente.Nombre" type="text" placeholder="Ingrese Nombre" ></b-form-input>
																<CValidation v-if="this.errorvalidacion.Nombre" :Mensaje="'*' + errorvalidacion.Nombre[0]"/>
                                                            </div>

															<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                            	<label for="ApellidoPat">Apellido Paterno</label>
																<b-form-input id="ApellidoPat" readonly v-model="objCliente.ApellidoPat" type="text" placeholder="Ingrese Apellido Paterno" ></b-form-input>
																<CValidation v-if="this.errorvalidacion.ApellidoPat" :Mensaje="'*' + errorvalidacion.ApellidoPat[0]"/>
                                                            </div>

															<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                            	<label for="ApellidoMat">Apellido Materno</label>
																<b-form-input id="ApellidoMat" readonly v-model="objCliente.ApellidoMat" type="text" placeholder="Ingrese Apellido Materno" ></b-form-input>
														...
														<div class="form-group form-row">
															<div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
																...
																<b-form-input id="ApellidoMat" readonly  v-model="objCliente.FechaNacimiento" type="text"  placeholder="0000-00-00" ></b-form-input>
																<CValidation v-if="this.errorvalidacion.FechaNacimiento" :Mensaje="'*' + errorvalidacion.FechaNacimiento[0]"/>
															</div>

															<div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
																<label for="Telefono">Teléfono</label>
																<input readonly id="Telefono" v-model="objCliente.Telefono" type="text" placeholder="Ingrese Teléfono" @input="$onlyNums($event,objCliente,'Telefono');" class="form-control"/>
																<CValidation v-if="this.errorvalidacion.Telefono" :Mensaje="'*' + errorvalidacion.Telefono[0]"/>
                                                            </div>

															<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
																<label for="Correo">Correo</label>
																<b-form-input id="Correo" readonly v-model="objCliente.Correo" type="email" placeholder="Ingrese Correo " ></b-form-input>
											...
											<fieldset class="mt-2">
												...
												<div class="form-group form-row">
													<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
														...
														<b-form-textarea id="DescripcionEmpresa" readonly v-model="objCliente.DescripcionEmpresa" placeholder="Ingrese Descripción Empresa"></b-form-textarea>
											...
											<fieldset class="mt-2">
												...
												<div class="form-group form-row">
													<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
														...
														<b-form-input id="Calle" readonly v-model="objCliente.Calle" type="text" placeholder="Ingrese Calle"></b-form-input>
													...
													<div class="col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2">
														...
														<b-form-input id="NoExt" readonly v-model="objCliente.NoExt" type="text" placeholder="Ingrese Número Exterior"></b-form-input>
														<CValidation v-if="this.errorvalidacion.NoExt" :Mensaje="'*' + errorvalidacion.NoExt[0]"/>
													</div>

													<div class="col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2">
														<label for="NoInt">Número Interior</label>
														<b-form-input readonly id="NoInt" v-model="objCliente.NoInt" type="text" placeholder="Ingrese Número Interior"></b-form-input>
														<CValidation v-if="this.errorvalidacion.NoInt" :Mensaje="'*' + errorvalidacion.NoInt[0]"/>
													</div>

													<div class="col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2">
														<label for="Cp">Código Postal</label>
														<input readonly id="Cp" v-model="objCliente.Cp" type="text" placeholder="Ingrese Código Postal" @input="$onlyNums($event,objCliente,'Cp');" class="form-control"/>
												...
												<div class="form-group form-row">
													<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
														...
														<b-form-input readonly id="Colonia" v-model="objCliente.Colonia" type="text" placeholder="Ingrese Colonia" ></b-form-input>
														<CValidation v-if="this.errorvalidacion.Colonia" :Mensaje="'*' + errorvalidacion.Colonia[0]"/>
													</div>

													<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
														<label for="Estado">Estado</label>
														<select id="Estado" class="form-control form-select" readonly v-model="objCliente.IdEstado" @change="ListaMunicipios()">
													...
													<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
														...
														<select readonly v-model="objCliente.IdMunicipio" id="Municipio" class="form-control form-select">
															<option :value="0">--Seleccionar--</option>
													...
													<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
														<div class=" form-group form-row">
															<div class="col-12 col-sm-12 col-md-4 col-lg-4col-xl-4">
																...
																<select readonly id="IdSucursal" v-model="objPrestamo.IdSucursal" class="form-control form-select" @change="ListaRutas()" >
																	<option :value="0">--Seleccionar--</option>
															...
															<div class="col-12 col-sm-12 col-md-4 col-lg-4col-xl-4">
																...
																<select readonly id="IdRuta" v-model="objPrestamo.IdRuta" class="form-control form-select" @change="ListaRutasEmpleados()" >
																	<option :value="0">--Seleccionar--</option>
															...
															<div class="col-12 col-sm-12 col-md-4 col-lg-4col-xl-4">
																...
																<select readonly id="IdEmpleado" v-model="objPrestamo.IdCobratario" class="form-control form-select">
																	<option :value="0">--Seleccionar--</option>
															...
															<div style="display:none" class="col-12 col-sm-12 col-md-4 col-lg-4col-xl-4">
																...
																<v-date-picker :masks="masks" :popover="{ visibility: 'focus' }" locale="es" v-model="objPrestamo.FechaAutorizacion" >
															...
															<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 border-top my-3"></div>

															<div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
																<label for="MontoSolicitud">Monto Solicitud</label>
																<select readonly id="MontoSolicitud" v-model="objPrestamo.IdMontoSolicitud" name="MontoSolicitud" class="form-control form-select" @change="GetMonto();">
																	<option value="0">--Seleccionar--</option>
															...
															<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
																<label readonly for="Observaciones">Observaciones</label>
																<b-form-textarea id="Observaciones" readonly v-model="objPrestamo.Observaciones" placeholder="Ingrese Observaciones" ></b-form-textarea>
															</div>
														</div>
													</div>
												</div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 mt-3">
											...
											<fieldset class="mt-2">
												...
												<div class="form-group form-row">
													<div class="col-12 col-sm-12 col-md-3 col-lg-2 col-xl-2" v-for="(item2,index2) in ListaDomicilioArray" :key="index2">
											...
											<fieldset class="mt-2">
												<div class="row">
													<div class="col-12 col-sm-12 col-md-10 col-lg-10 col-xl-10">
														<legend class="col-form-label">Local/Empresa</legend>
													</div>
												</div>
	...
	export default {
		...
		methods: {
			async Guardar()
			{
				...
				formData.set('IdEmpleado', this.objPrestamo.IdEmpleado);
				formData.set('IdCobratario', this.objPrestamo.IdCobratario);
				formData.set('IdSucursal', this.objPrestamo.IdSucursal);
				formData.set('IdMontoSolicitud', this.objPrestamo.IdMontoSolicitud);
				formData.set('MontoSolicitud', this.MontoSeleccionado);
				...
				if(this.ListaDomicilioArray.length <2){
					this.$toast.warning('Debe agregar ambas fotografías del domicilio');
					return false;
				}
			...
			{
				let newObj = { IdClienteEvidencia: 0, IdCliente: 0, TipoEvidencia: '', Evidencia: "", Observaciones: "" };
			...
			{
				window.open(this.RutaEvid+item.Evidencia);
			},
			GetMonto()
			{
